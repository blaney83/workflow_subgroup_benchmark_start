 ...
 */
public class SubgroupBenchmarkStartNodePlugin extends Plugin {
    // The shared instance.
    private static SubgroupBenchmarkStartNodePlugin plugin;

    /**
     * The constructor.
     */
    public SubgroupBenchmarkStartNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SubgroupBenchmarkStartNodePlugin getDefault() {
        return plugin;
    }
